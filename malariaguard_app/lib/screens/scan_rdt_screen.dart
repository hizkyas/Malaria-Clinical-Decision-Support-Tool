...
class _ScanRdtScreenState extends State<ScanRdtScreen> with SingleTickerProviderStateMixin {
        ...
        children: [
          ...
          AnimatedBuilder(
            ...
            builder: (context, child) {
              return Positioned(
                top: (MediaQuery.of(context).size.height / 2 - 60) + (120 * _laserAnimation.value),
                left: MediaQuery.of(context).size.width * 0.1,
                width: MediaQuery.of(context).size.width * 0.8,
                child: Container(height: 2, color: Colors.redAccent.withValues(alpha: 0.8)),
              );
            },
          ),
              ...
              child: _isProcessing
                ? Column(
                    children: [
                      ...
                      Text("Analyzing... | በመተንተን ላይ...", style: GoogleFonts.outfit(color: Colors.white)),
                    ],
                  )
